...
class WalletPage extends StatelessWidget {
  ...
  final List<ExpenditureData> data = [
    ExpenditureData(
      year: "Mon",
      subscribers: 3000,
      barColor: charts.ColorUtil.fromDartColor(const Color.fromRGBO(232, 241, 253, 1)),
    ),
    ExpenditureData(
      year: "Tue",
      subscribers: 4000,
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: const Center(
                  child: Text(
                    'Mn',
                    style: TextStyle(
                        fontSize: 14, color: Color.fromRGBO(115, 138, 169, 1)),
                  ),
                ),
              ),
              const SizedBox(
              ...
              Container(
                ...
                child: const Center(
                  child: Text(
                    'Yr',
                    style: TextStyle(fontSize: 14, color: Color.fromRGBO(115, 138, 169, 1)),
                  ),
                ),
              ),
              ],)
                ...
                child: Row(
                  ...
                  children:<Widget> [
                    ...
                    Column(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children:<Widget> [
                      const Text('Create quick saving goals with \n friends and colleage'),
                      Align(
                        alignment: Alignment.topRight,
                        child: TextButton(onPressed:(() => {}), child: const Text('Save now',
                        style: TextStyle(color:Color.fromRGBO(47, 128, 237, 1)),)),
                      )
                    ],)
                  ],
                ),
